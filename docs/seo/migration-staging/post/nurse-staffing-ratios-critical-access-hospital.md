<!-- MIGRATION STAGING COPY - NOT FOR PUBLICATION - source: src/data/post/nurse-staffing-ratios-critical-access-hospital.md - source-hash: 2beee0193597527ef21d44191443e0d297faf5ab -->
...
<div class="not-prose my-12 rounded-xl bg-blue-50 dark:bg-slate-800 border border-blue-100 dark:border-slate-700 px-8 py-10 text-center">
  ...
  <p class="text-slate-500 dark:text-slate-400 text-sm mb-6">
    See how SimpleScheduleAI builds your committee-approved staffing plan into every draft and flags below-plan shifts before you publish. The AI builds the schedule, you approve it.
  </p>
  <a
    href="/pricing"
