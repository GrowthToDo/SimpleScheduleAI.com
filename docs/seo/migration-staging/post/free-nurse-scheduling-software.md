<!-- MIGRATION STAGING COPY - NOT FOR PUBLICATION - source: src/data/post/free-nurse-scheduling-software.md - source-hash: 3cdf256711117a18a1bf9bd33f3d6b50b4c995a6 -->
---
draft: false
...
<div class="not-prose my-12 rounded-xl bg-blue-50 dark:bg-slate-800 border border-blue-100 dark:border-slate-700 px-8 py-10 text-center">
  ...
  <p class="text-slate-500 dark:text-slate-400 text-sm mb-6">See how the schedule gets built, checked, and approved, with overtime tracking and callout coverage built in.</p>
