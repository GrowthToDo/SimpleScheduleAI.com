<!-- MIGRATION STAGING COPY - NOT FOR PUBLICATION - source: src/data/post/self-scheduling-problems-critical-access-hospital.md - source-hash: 8d073864163ce9c841183cc3f95a68f98627be41 -->
---
...
- [Why Does Self-Scheduling Break Down at a Critical Access Hospital?](#why-does-self-scheduling-break-down-at-a-critical-access-hospital)
...
[AONL nurse manager workforce data](https://www.aonl.org/resources/workforce) identifies scheduling inequity as a primary driver of charge nurse and staff nurse burnout at small facilities. The mechanism is consistent: reliable nurses say yes more than others, and over time, yes becomes the expectation. Once that expectation is set, the nurses carrying the burden either get used to it or they leave. Whether that churn is best read as a national nurse shortage or a retention problem a small hospital can actually control is the question we take up in [is it a nurse shortage or a retention crisis](/articles/nurse-shortage-or-retention-crisis-rural-hospitals).
...
5. **See how SimpleScheduleAI works if you are a Texas Critical Access Hospital.** Guided-setup software applies constraint-aware fairness rules before nurses self-pick, so the system distributes the unwanted shifts evenly before anyone has the chance to avoid them. Start at [how it works](/how-it-works).
