...
4. **The nurse-rostering pair, leave it and re-read at end of September (founder, 2026-09-05).** `nurse-rostering-vs-scheduling-software` (comparison, 284 impressions, 0 clicks, head query "nurse rostering software" 118 impressions at 11.4) and `what-is-nurse-rostering` (glossary, 58 impressions, 0 clicks) overlap on four queries: healthcare rostering 21/9, nurse rostering 22/16, nurse scheduling 35/4, roster scheduling software nurse 12/1, the comparison post ahead on all four. Head queries are distinct and the pages cross-link, so this is a soft split. Options if still at zero clicks in October, in order: tighten the comparison post opening to defer the definition to the glossary; merge the glossary in and 301. No page touched.
