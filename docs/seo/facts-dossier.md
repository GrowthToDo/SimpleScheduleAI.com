...
### Texas CAH roster — Flex Monitoring Team named list (92 entries, September 2026)

- Approved wording: "the Flex Monitoring Team's Texas list holds 92 hospitals" / "92 entries, retrieved 4 September 2026". The retrieval date travels with the number, always.
- **This entry does NOT change the headline count rule above.** For any general "Texas has N critical access hospitals" claim the answer stays **93**. 92 is the row count of one named-facility roster on one day; use it only when the Flex list is the thing being described, reproduced, or counted.
- **The 92-vs-93 gap is real and gets SHOWN, never silently resolved.** Flex Monitoring Team = 92 (retrieved 2026-09-04); RHIhub Texas state guide = 93 (read live 2026-09-04; page "Last Updated: 7/20/2026"). Both checked the same day. Neither is wrong — they are different snapshots of federal certification data taken on different days. Wrong: picking one and presenting it as exact; writing either figure without its source and date.
- In-repo copy of the source rows: `docs/seo/data/tx-cah-flexmonitoring-2026-09-04.csv` (founder-supplied 2026-09-04; columns Name, City, State, ZIP, Certified Date, Beds; 92 data rows, all State = Texas, no blanks, no unparseable dates). Re-derive any statistic from this file, never from published prose about it.
- **Derived statistics, all recomputed from the CSV by independent parse on 2026-09-04:**
  - **64 of 92 at exactly 25 beds** (69.6%, safely "seven in ten"). No row exceeds 25.
  - **Mean 22.6 beds** (2,079 beds / 92 = 22.598).
  - **28 below 25 beds; 18 under 20; 12 at 15 or fewer.** Smallest is **10 beds** (Mother Frances Hospital-Jacksonville, Jacksonville).
  - **Certification years span 1999 to 2025.** 7 certified 2023 or later — **4 in 2023, ZERO in 2024, 3 in 2025.** Do not gloss "seven since 2023" as a steady trickle; there is a gap year in it.
  - **67 of 92 certified before 2006 = 72.8%.** Write this as "more than two thirds" or "nearly three quarters". A bare "two thirds" (66.7%) understates it by six points.
- Texas **Rural Emergency Hospitals = 4**, from the same RHIhub page (read out of the raw page HTML 2026-09-04, alongside 387 Rural Health Clinics and 226 Federally Qualified Health Centers). REH is a conversion route OFF the CAH list; never describe an REH as a critical access hospital.
- **GUARDRAIL — flexmonitoring.org 403s automated fetchers but loads normally for a human reader.** Same documented false positive already recorded for the Flex policy-brief PDFs elsewhere in this dossier. `check-links` and any external link report WILL flag this URL as dead. That flag is expected and correct to ignore: do NOT "fix" it by removing, swapping, or unlinking the source.
- Two transformations are applied when this CSV is rendered into a published table, and only these two: the full certification date is displayed as its YEAR, and the 4 rows stored in ALL CAPS are set in title case (Dimmit Regional Hospital / Carrizo Springs, Hill Regional Hospital / Hillsboro, Memorial Hospital / Dumas, Uvalde Memorial Hospital / Uvalde). Any other difference between CSV and table is a defect. Note the CSV legitimately contains two distinct hospitals both named "Memorial Hospital" (Seminole, 25 beds, 2004; Dumas, 25 beds, 2013) — match on name AND city, never on name alone.
- URL: https://www.flexmonitoring.org/critical-access-hospital-locations (Texas rows). Cross-source: https://www.ruralhealthinfo.org/states/texas
- Verified: 2026-09-04 (CSV parsed independently and reconciled row by row against the 92-row table in `critical-access-hospitals-in-texas` — 92/92 exact on name, city, beds and certification year, no duplicate, dropped or truncated row; RHIhub's 93 CAHs, 4 Rural Emergency Hospitals and 7/20/2026 update date read from the raw page HTML the same day)
...
### Federal Rural Health Transformation Program (RHTP) rules and calendar

- Approved figures: $50 billion total, allocated to approved states over five fiscal years, $10 billion each fiscal year, FY2026 through FY2030; created by Section 71401 of Public Law 119-21 (adds Social Security Act Section 2105(h)). Administrative expenses capped at 10 percent of a state allotment (STATUTORY). Direct provider payments (Use of Funds Category B) capped at 15 percent of what CMS awards a state in a given budget period (CMS POLICY, set in the NOFO, NOT statutory). Salary rate limitation applies, given as $225,700 as of January 2025.
- Budget period calendar: Budget Period 1 runs December 31, 2025 through **October 30, 2026**; BP2 begins October 31, 2026. All BP1 funds must be OBLIGATED by October 30, 2026 or they are "returned and redistributed"; CMS has confirmed there are NO extensions. Funds obligated in time may be spent through September 30, 2027.
- **The personnel carve-out (the citable one):** CMS states "personnel-related costs, such as salary and fringe, must be expended within the budget period in which the expense is incurred." So salary money does NOT get the extra fiscal year that contract costs get.
- Reporting/rescoring: Annual report #1 was due **August 30, 2026** (covering a 7-month period), states to CMS. CMS rescoring runs September to October 2026 and sets FY2027 allocations, announced by October 31, 2026. Policy and initiative factors are recalculated each budget period; data-driven factors stay fixed.
- Salaries, what IS allowed: clinician salary and wage support inside an approved initiative where the facility has no non-compete; Category E workforce salaries where the clinical workforce employee commits to five years of rural service and the contract has no non-compete clause; resident and fellow salaries/stipends during training; sign-on, recruitment and retention bonuses; relocation, travel, per diem, lodging and childcare incentives (with state justification and CMS approval); hiring and training NEW community health workers for new populations/areas (Category A, nonclinical, no 5-year commitment).
- Salaries, what is NOT allowed: "Supplanting existing State, local, tribal, or private funding of infrastructure or services, such as staff salaries" (NOFO Limitations, p.18); "Clinician salaries or wage supports for facilities that subject clinicians to non-compete contractual limitations" (NOFO p.20); salaries of existing staff in an expanded program, except the share of their work covering the new geography; payments to employees not tied to a specific initiative or quality improvement; student loan repayment and issuing student loans.
- **SILENT (do not claim either way):** float pools, staffing pools, rotational or shared staffing, locum tenens, agency or temporary staffing, contract labor, travel nursing, and scheduling systems or software appear NOWHERE across the NOFO, both CMS FAQs, both fact sheets, the Category E workforce guide and the statute (grep-verified, zero hits, 2026-09-21). Never write that RHTP permits or forbids any of these. West Virginia funding rotational staffing pools ($1.8M, July 14, 2026) is a STATE reading of silent rules, not a federal category.
- Wrong: citing the CMS program page (medicaid.gov/resources-for-states/rural-health) for any RESTRICTION; that page carries only the ten statutory uses of funds and no prohibition, cap or deadline language. Wrong: "routine operating costs" and "covering financial losses" as prohibitions; neither phrase appears in any primary source, and the nearest real wording is a sustainability test, "funding perpetual ongoing operating expenses with no path to sustainability." Wrong: Budget Period 1 ending September 30, 2026 (it is October 30, 2026; September 30, 2027 is the separate outer spending deadline). Wrong: "states must implement before the first program review, September 2026" (a Chartis paraphrase with no CMS basis; the real September-October event is CMS-side rescoring).
- URLs: https://www.medicaid.gov/resources-for-states/rural-health (program, $50B) | https://apply07.grants.gov/apply/opportunities/instructions/PKG00291485-instructions.pdf (NOFO: limitations, non-compete, 15% cap, salary rate cap) | https://www.cms.gov/files/document/rural-health-transformation-frequently-asked-questions.pdf (pre-award FAQ: budget period dates, 5-year commitment, incentives, spending window) | https://www.cms.gov/files/document/frequently-asked-questions-april-2026.pdf (post-award FAQ: obligation rule, no extensions, personnel carve-out) | https://www.cms.gov/files/document/provider-payments-fact-sheet.pdf | https://www.cms.gov/files/document/5-year-service-commitment-fact-sheet.pdf | https://www.medicaid.gov/resources-for-states/rural-health/rhtp-resources/CatE-Workforce-Info-Guide.pdf | https://www.cms.gov/files/document/rht-program-reporting-rescoring-webinar-02-25-26.pdf (reporting/rescoring) | https://www.cms.gov/files/document/chapter-4-protecting-rural-health-hospitals-providers.pdf (statute)
- Verified: 2026-09-21 (all seven federal documents downloaded and text-extracted directly, not read from search summaries; the grants.gov NOFO and the CMS PDFs required pdftotext because WebFetch could not read them)
...
### Nurse staffing relief factor, FTE hours and the 0.9-FTE 3x12 nurse

- VA definition (current, verbatim, VHA Directive 1351, January 18, 2023): "The replacement factor is an estimated forecast of staff replacement to ensure nurse staffing targets are consistently met. The replacement factor calculates the percentage of time staff is away from the unit not performing direct patient care duties such as, but not limited to, sick leave, annual leave, leave without pay, military leave, union steward official time, continuing education and committee work." URL: https://www.va.gov/vhapublications/ViewPublication.asp?pub_ID=10117 (PDF; verified by text extraction 2026-09-26; the 2023 text contains NO numeric factor).
- Historical only: the RESCINDED 2017 VHA Directive 1351 said "The replacement factor of 1.2 may be increased ... but may not be decreased from 1.2" and flagged factors above 1.24 in 24/7 units. Write it as "VA policy from 2017 to 2023 set a floor of 1.2", never as a current or typical value.
- FTE convention (Hunt PS, Nursing Management 49(5):24-31, May 2018, verbatim): "80 hours per 14-day pay period or for a total of 2,080 hours per year". Method, verbatim: "divide the average number of nonproductive hours per FTE by 2,080 hours (number of hours one FTE would work in 1 year without taking any time off). The resulting number is the percentage of lost time." Advice, verbatim: "calculate the nonproductive percentage for your individual department once a year at budget time to determine the exact number". URL: https://www.ovid.com/jnls/nursingmanagement/fulltext/10.1097/01.numa.0000532326.62369.9b~developing-a-staffing-plan-to-meet-inpatient-unit-needs
- 3x12 nurse, same source, verbatim: "12 hours per day × 6 days per pay period = 72 hours per pay period/80 hours = 0.9 FTE"; "A common mistake is to count the 12 hours per day, 6 days per pay period employee as 1.0 FTE."
- Nonproductive time, verbatim (Hunt PS, Hartman D, Nursing Management 49(6):26-33, June 2018): "Nonproductive hours are those hours paid to staff members when they haven't worked, including PTO; sick days; holidays; and time for funerals, jury duty, and so on."
- Guardrails: no current published "typical" relief factor was found (search snippets claiming 1.1-1.2, 1.4-1.7 or "85% productive" are unsourced; do not use). Corrections-industry "shift relief factor" also counts regular days off (numbers like 1.79) and is a DIFFERENT quantity; never cite it as a nursing benchmark. Always separate FTE from headcount.
- CORPUS FIX (T10), 2026-09-26: 2 RNs around the clock = 2 x 24 x 365 = 17,520 hours = 8.42 FTE BEFORE any time off. The 12-hour post's FAQ said "8-10 FTE ... allowing for days off, leave" (8 is below the no-leave floor); corrected the same day.
- Verified: 2026-09-26 (VA PDF text-extracted; Hunt articles read via the saved source; research agent brief)
...
- **CORRECTION 2026-09-24 (adversarial fact-check, read at texas.public.law):** the approved wording above is INCOMPLETE. §258.002 defines mandatory overtime as "a requirement that a nurse work hours or days that are in addition to the hours or days scheduled", so ordering an off-duty nurse in for an extra DAY is also barred, which matters for holiday and callout content. Preferred wording from now on: "bars a hospital from requiring a nurse to work extra hours or extra days beyond her schedule, and a nurse may refuse." §258.003(a): "A hospital may not require a nurse to work mandatory overtime." Live posts carrying the hours-only wording are narrower, not wrong; update them on their next edit.
- **CORRECTION 2026-09-24, the exception duty is softer than "must first".** §258.004(b) verbatim: "If a hospital determines that an exception exists under Subsection (a)(3), the hospital shall, to the extent possible, make a good faith effort to meet the staffing need through voluntary overtime, including calling per diems and agency nurses, assigning floats, or requesting an additional day of work from off-duty employees." Write "must make a good-faith effort, as far as possible, to cover with volunteers", never "must first try".
...
### Floating: safety, nurse rights, and what a hospital owes a floated RN (NYSNA position statement)

- **Status of the source.** NYSNA "Position Statement on Floating". Footer reads verbatim: "Reviewed/revised by NYSNA's Expanded Council on Nursing Practice 06/02/06 and 12/01/06. Approved by the Board of Directors on 06/08/06 and 01/23/07. **Reviewed/revised March 8, 2018**". March 8 2018 is the most recent revision shown; the statement is live, not superseded or withdrawn (page loads 200, still listed under Position Statements). "Last reviewed in March 2018" is the correct way to date it.
- **Approved wording (verbatim), the safety claim:** "Floating to unfamiliar specialty nursing units is a common practice by employers in many healthcare settings, especially during times of otherwise anticipated staffing shortages and fluctuating census. This practice **poses grave concerns regarding patient safety and potential liability for both the professional nurse as well as the facility**."
- **Approved wording (verbatim), the sentinel-event finding, WITH ITS DATE:** NYSNA writes: According to the Joint Commission (JC), "...**inadequacy of orientation and training was identified as the most common root cause of more than half of all sentinel events reviewed**" (2004, p. 5). NYSNA's reference list gives the primary source as Joint Commission on Accreditation of Healthcare Organizations (2004), "Systems analysis. Ensure that your float staff and contracted staff are providing safe care," _Joint Commission Perspectives on Patient Safety_, 4(7), 5-6.
  - **Guardrail: the finding is 2004 data, not 2018 data.** The statement's 2018 review date sits near this quote and readers will assume the sentinel-event number is recent. Date the finding (2004) whenever the 2018 review date is also on the page.
  - **Guardrail: NYSNA's wording is "inadequacy of orientation and training", not "inadequate orientation and training".** Keep any reworded lead-in outside the quotation marks.
- **Approved wording (verbatim), the nurse's right, COMPLETE:** "RNs have the right and responsibility to express their concerns and protest an assignment in writing **if placed in a potentially unsafe practice situation** without fear of retribution."
  - "without fear of retribution" is genuinely in the statement. **But the right is conditioned.** Do not quote "...protest an assignment in writing" and then jump to "without fear of retribution" in a way that drops "if placed in a potentially unsafe practice situation" — that broadens a conditional right into a general one. Quote the sentence whole, or keep the condition in the surrounding prose.
  - Related, from the RECOMMENDATIONS section: the RN should "Inform the supervisor, if given an assignment that involves knowledge or skills beyond his or her competency level, in writing and exercise his/her right to file a Protest of Assignment, without fear of reprisal".
- **Approved wording (verbatim), what the supervisor owes:** "When floating is implemented in unanticipated emergency situations, **assign a proficient, regularly scheduled staff member to the floated RN to act as a mentor** to the floated RN" and "When floating is implemented to supplement staffing in emergency situations, **reduce the patient assignment of both the mentor and the floated RN**". Facility-level duty: "Provide adequate orientation and training for RNs expected to float to unfamiliar practice settings".
  - **Guardrail: both mentor recommendations are conditioned on emergency situations.** NYSNA's headline recommendation is the opposite of a blessing for routine floating: "Floating of professional nurses to unfamiliar practice settings **should be avoided** as it poses potential risks for unsafe practice situations" and "Floating of nurses should only be used in otherwise unanticipated, emergent situations". Never present the mentor-plus-lighter-load pair as NYSNA endorsing floating as normal practice.
- **Bonus, and directly on-topic for float pools:** NYSNA calls the internal pool the preferred fix — "The optimum solution to emergency staffing, such as in a sudden and unanticipated fluctuation in census or unexpected increase in absenteeism, is the establishment of an internal pool of competent personnel whose credentials have been evaluated and who have been oriented and trained to the facility's units, supplies, equipment, and current policies".
- **Wrong:** dating the sentinel-event finding to 2018; dropping the "potentially unsafe practice situation" condition from the protest right; citing the mentor recommendations without the emergency-situation qualifier; describing this as an ANA or national position (it is a New York state association statement).
- URL: https://www.nysna.org/position-statement-floating
- Verified: 2026-09-03 (full body fetched and read; loads normally with a browser UA)

### Float pool employment terms: skill areas, experience bar, pay options (WakeMed careers page)

- **Approved wording (verbatim), the skill areas.** The page reads: "Float pool nurses are able to develop their skills by **floating within skill areas:**" followed by a five-item list — "Medical/Surgical, Telemetry and Stepdown" / "Critical Care" / "Adult and Children EDs" / "Women, Infant and Children Services" / "And more based on experience."
  - **Guardrail: the list is a bulleted list, not a comma-run sentence, and it does not end at the third bullet.** If the quote is flattened into prose and cut after "Adult and Children EDs", mark the cut with an ellipsis. Cutting silently also drops "And more based on experience", the one phrase telling the reader the list is NOT exhaustive, which matters when the quote is being used to argue that float range is bounded by clearance.
  - A SECOND, genuinely shorter list appears further down under the benefits-eligible positions: "floating within **select** skills areas:" — "Medical/Surgical, Telemetry and Stepdown" / "Critical Care" / "Adult and Children ED areas", three items, no "and more". If a three-area list is what is wanted, quote this one and use its "select skills areas" lead-in.
- **Approved wording (verbatim), the experience bar:** "Applicants must hold a current NC RN license and **have worked in the skills area applied for in a hospital for the past two years**." Stated identically under all three position groups. The paraphrase "two years of hospital experience in each skill area a nurse applies to float into" is accurate.
- **Count confirmed: EXACTLY EIGHT compensation options**, labelled OPTION 1 through OPTION 8, in three groups — Options 1-4 float pool with Supplemental benefits (availability minimums such as "32 hours per month minimum", self-scheduling, pay $47.25 / $52.00 / $60.25 / $63.25); Options 5-6 benefits-eligible full-time float ("72-80 hours each pay period", pay $52.00 / $54.50, Benefits: Full time); Options 7-8 contract positions ("72 hours each pay period", $70.00 days/evenings and $70.00 nights, Benefits: Supplemental). "Eight compensation options for float and contract work" is correct as written.
- **Guardrail: every rate reads "plus applicable shift differentials", which are SHIFT differentials, not FLOAT differentials.** This page is not evidence that hospitals pay a premium for floating. It shows pay varying by availability commitment, unit group, and benefits status inside one system. Use it for spread, never for "float pays X% more".
- **Guardrail: do not cite WakeMed for "float pool nurses usually hold a guaranteed line".** Four of the six float options (1-4) are Supplemental, self-scheduled, and defined by an availability minimum rather than guaranteed hours. Only Options 5-6 are full-time benefits-eligible. The page cuts against that generalization more than it supports it.
- **This is a live recruiting page.** Dollar figures and option counts change without notice. Re-verify the count and any rate before restating either.
- URL: https://www.wakemed.org/careers/nursing-careers/float-pool-and-contract-positions
- Verified: 2026-09-03 (full page fetched; all eight OPTION blocks present and counted in the raw HTML)

### The floated nurse's own limit (Borgatti, "Tips for floaters", 2010)

- **Approved wording (verbatim), under the article's "Know your limits" heading:** "**Don't accept an assignment that's beyond your level of competency and could place a patient in jeopardy.** The buck stops with you when it comes to protecting your license. And only you can determine your level of competence and whether you can safely perform the tasks required on any unit to which you may be floated." (Source uses curly apostrophes; straight apostrophes are fine in our copy.)
- **Author confirmed: Joan C. Borgatti.** The page carries no top byline; authorship is stated in the closing bio, verbatim: "Joan C. Borgatti is the owner of Borgatti Communications in Wellesley, Massachusetts, which provides writing, editing, and coaching services."
- **Date confirmed: March 11, 2010** (visible on page; `article:published_time` and schema `datePublished` are both 2010-03-11). `dateModified` is 2019-10-11, a site-migration timestamp, not a revision to cite.
- **Citation correction: the 2010 publication name was American Nurse Today.** The ANA journal was renamed _American Nurse Journal_ in January 2020; myamericannurse.com now brands all archive content, including this 2010 piece, under the new name. Citing a 2010 article as "American Nurse Journal (2010)" is an anachronism. Preferred: "Joan C. Borgatti, 'Tips for floaters,' American Nurse Today (2010), published at myamericannurse.com". Acceptable alternative: drop the journal name and cite author, title, year and site. (The 2023 Bilyeu entry above is unaffected; American Nurse Journal was the correct name by then.)
- **Note:** the article's own reference list cites the NYSNA floating position statement, so the two sources in this cluster are not independent of each other on the refuse-an-unsafe-assignment point. Do not present them as two independent authorities converging.
- URL: https://www.myamericannurse.com/tips-for-floaters/
- Verified: 2026-09-03 (full body fetched; quote, byline bio and both date fields read directly)

### Float pool vs travel vs per diem: which distinctions are SOURCED and which are not

- **Sourced.** That float range is bounded by what the nurse is signed off for, and that hospitals set an experience bar before hiring into a float pool (WakeMed, above). That floating to unfamiliar units carries a recognised patient-safety and liability concern (NYSNA, above).
- **NOT sourced, and generalizations to write carefully.** No source in this cluster establishes: that travel nurses are employed by a staffing agency rather than the facility (true as the general case, but hospital-internal travel programs and direct-hire travel contracts exist, so write it as the usual arrangement rather than a definition); that per diem nurses usually work only one or two familiar units; that float pool nurses usually hold guaranteed full or part time lines (WakeMed actively cuts against this, see its guardrail above); that hospitals variously pay a float differential, a higher grade, or the same as unit staff.
- **The pay-variation hedge is safe only while it stays a hedge.** "Some hospitals pay a differential, some a higher grade, and some the same as unit staff" asserts variation, not a benchmark, and is defensible unattributed. The moment a percentage or dollar premium is attached it needs a named, dated source. There is no verified float-differential figure in this dossier.
- **"Published figures disagree with each other and the surveys behind them are frequently undated"** is a claim ABOUT sources that names none. It is honest, and it correctly refuses to launder an unverified number, but it cannot itself be verified. Keep it as a reason for not quoting a figure; never build a comparison on it.
- Verified: 2026-09-03 (scope note recorded during the float-pool fact-check; no new external source)

### Holiday nurse callouts: what the evidence does and does not say (added 2026-09-24)

Collected for `december-nurse-callout-surge-cah`. Every item read against its primary text (PubMed via NCBI E-utilities, Dexter full text PMC7568467, CDC via WebFetch).

- **No published holiday callout-rise figure exists for nurses.** Approved wording: "As of September 2026, we found no government or peer-reviewed figure for how much nurse callouts rise over the holidays." Three PubMed searches plus web searches found none (2026-09-24). Re-check before reusing.
- **The "up to 30%" figure is uncited agency marketing.** Earliest found: NurseRegistry blog, 2024-11-26 ("nurse call-offs increasing by up to 30% during the Thanksgiving and Christmas periods"), no citation. HelpSquad (2025-12-18) repeats it citing NurseRegistry. Never cite it as data.
- **Dexter F, Epstein RH, Marian AA (three authors, no et al.)**, Perioper Care Oper Room Manag 2020;21:100139, PMID 33102816. Title: "Comparisons of unscheduled absences among categories of anesthesia practitioners, including anesthesiologists, nurse anesthetists, and anesthesia residents." University of Iowa anesthesia staff, two years. Verbatim: "Mondays, Fridays, and days adjacent to holidays had significantly more unscheduled absences than Tuesdays, Wednesdays, and Thursdays (1.45 [1.19-1.76], P<.0001)." The 1.45 is an ODDS RATIO for the POOLED group; never write "1.45x on days next to holidays" or any holiday-only multiplier. "the Wednesdays before Thanksgiving (i.e., holiday Thursdays) were in the 2nd group."
- **Counter-evidence, always pair with Dexter:** the same paper says "Unlike at the University of Miami, the proportional incidences of unscheduled absences differed among weekdays." The earlier Miami study (PMID 30149226) found "minor differences among days of the week or on the day before or after a vacation or holiday." Wrong: "the best evidence shows absences cluster around holidays."
- **Piersa AP, Tung A, Dutton RP, Shahul S, Glick DB**, Anesthesiology 2021;135(5):804-812, PMID 34525169. 3,504,394 adult ELECTIVE ANESTHESIA cases at the Florida and Texas locations of ONE large multistate anesthesia practice, 2017-2019; obstetric, weekend and holiday cases excluded. Verbatim: December 2017 daily caseload "a 20% increase over the January-to-November baseline" (after adjusting for time trends); 21.3% in 2018, 21% in 2019. The deductible explanation is the authors' HYPOTHESIS, not a finding. Wrong: "surgery in Texas and Florida rises 20%" (it is one practice's elective anesthesia caseload); "deductible-driven".
- **CDC flu timing.** https://www.cdc.gov/flu/about/season.html: "most of the time flu activity peaks between December and February"; most often February (17 seasons), then December (7). 2024-25: https://www.cdc.gov/flu/whats-new/2025-2026-influenza-activity.html, "Influenza activity began increasing in mid-November and peaked in early February 2025." Never write that flu peaks "in December".
- **Calendar check:** Thanksgiving to New Year's Day is 36 to 40 days depending on the year, never six weeks. Say "about five weeks".
- Verified: 2026-09-24
...
| 2026-09-03 | Added the **float-pool cluster** (NYSNA floating position statement, WakeMed float pool careers page, Borgatti "Tips for floaters") for what-is-a-float-pool-nurse, the dossier's first float-pool entries. All five NYSNA quotes, both WakeMed quotes and the Borgatti quote verified verbatim against live pages; NYSNA's March 8 2018 review date confirmed as the current revision; WakeMed's eight compensation options counted in the raw HTML (exactly eight). Four things the post's word could not be taken for: NYSNA's sentinel-event finding is **2004** Joint Commission data, not 2018; the protest right is conditioned on "if placed in a potentially unsafe practice situation" and the mentor recommendations on emergency situations only; the WakeMed skill-area list has five bullets, not three, and a silent cut drops "And more based on experience"; the 2010 Borgatti article appeared in **American Nurse Today** (renamed American Nurse Journal in Jan 2020), so "American Nurse Journal (2010)" is an anachronism. Also recorded a scope entry separating the sourced float/travel/per-diem distinctions from the unsourced ones, including that WakeMed cuts AGAINST "float nurses usually hold guaranteed lines" (4 of its 6 float options are supplemental). | Claude |
| 2026-09-04 | Added **"Texas CAH roster — Flex Monitoring Team named list (92 entries)"** for the critical-access-hospitals-in-texas data-asset post, with the founder-supplied source rows committed in-repo at `docs/seo/data/tx-cah-flexmonitoring-2026-09-04.csv`. **The headline-count rule is UNCHANGED — 93 stays the answer for general "Texas has N CAHs" claims**; 92 is one roster's row count on one day, and the 92-vs-93 gap is published with both sources and both dates rather than resolved. Table integrity verified the hard way: an independent CSV parser and HTML-table parser reconciled all 92 rows on name, city, beds and certification year (92/92 exact, zero orphans either direction, zero duplicated/dropped/truncated rows); the only transformations are year-from-full-date and title-casing the 4 all-caps source rows. All nine derived statistics recomputed from the CSV. Three things the prose could not be taken for: **2024 has ZERO certifications**, so "seven since 2023" is 4+0+3, not a trickle; **67/92 is 72.8%**, materially closer to three quarters than to the "two thirds" the post says; and the file contains **two distinct hospitals both named "Memorial Hospital"** (Seminole and Dumas), so any future match must key on name AND city. RHIhub re-read from the RAW page HTML the same day (93 CAHs, 4 Rural Emergency Hospitals, "Last Updated: 7/20/2026") because a model-mediated fetch could not be quoted verbatim. Guardrail recorded: flexmonitoring.org 403s automated fetchers but loads for human readers, so link reports will flag it and must NOT "fix" it. | Claude |
| 2026-09-24 | Added "Holiday nurse callouts" entry (Dexter + Miami counter-evidence, Piersa, CDC flu timing, no-published-figure claim, 30% trace). Corrected Texas HSC Chapter 258 entry: mandatory overtime covers extra DAYS as well as hours (§258.002), and the (a)(3) exception duty is a good-faith effort "to the extent possible", not "must first" (§258.004(b)). Caught by the adversarial fact-check on december-nurse-callout-surge-cah. | Claude |
| 2026-09-25 | Added **42 CFR 485.625** (CAH emergency preparedness: staff contact list, alternate means of communication, continuity of operations, twice-yearly exercises; verbatim at Cornell LII) and the **Kronos Private Cloud ransomware outage (Dec 2021)** entry (UKG statement via AHA, Shannon Medical Center San Angelo, UMass Memorial; timekeeping/payroll guardrail) for the scheduling-outage post. | Claude |
| 2026-09-25 | Added **FLSA sets no cap on hours or consecutive shifts** (DOL overtime page, verbatim) for the 12-hour post's consecutive-shifts H2, and **FLSA: hours for the same employer combine across departments** (DOL FS#54 'Two Different Jobs', 29 CFR 778.115) for the PRN pool draft. | Claude |
| 2026-09-26 | Added **HIPAA Security Rule automatic logoff** (45 CFR 164.312(a)(2)(iii) Addressable; 164.306(d)(3); never claim HIPAA requires a scheduling app timeout or a minute figure) for the login-problems draft, and **Nurse staffing relief factor** (VHA Directive 1351 2023 verbatim, text-extracted; rescinded 2017 1.2 floor as history only; Hunt 2018 Nursing Management FTE and 0.9-FTE 3x12 quotes). Corrected the 12-hour post FAQ the same day: 2 RNs around the clock = 8.42 FTEs before time off, not '8-10 FTE allowing for leave'. | Claude |
