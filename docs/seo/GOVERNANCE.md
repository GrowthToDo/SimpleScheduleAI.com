...
| `docs/design/DESIGN.md`                                                             | **Visual law (BINDING since 2026-07-21).** Founder closed redesign Phase 0 as "current theme, formalized": tokens (forest/ink/ivory/sage), Fraunces+Inter, button system, hero/eyebrow/FAQ idioms, blog in-post idioms, deck palette, light-only mode. Every page, post, deck, and generated asset conforms visually to it; a visual change conforms or updates DESIGN.md in the same commit. Conformance state: `docs/design/theme-conformance-audit-2026-07-21.md`. | Copy, claims, positioning (registry + dossiers), process, mechanical checks. A visual rule never changes what a sentence says. |
