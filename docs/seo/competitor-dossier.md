...
**Product:** Self-serve scheduling platform. Parent company: TCP Software (acquired Aladtec **October 21, 2021** — verified 2026-09-15 against TCP's own press release, businesswire.com/news/home/20211021005270/en/TCP-Software-Acquires-Aladtec, and matching trade coverage in Firehouse/JEMS/Fire Apparatus Magazine). **A prior blog draft asserted "acquired in 2019" with a supporting Capterra blockquote ("Customer support quality declined after the TCP acquisition") attributed to "multiple reviewers" — neither the date nor the quote could be verified. Capterra sentiment is actually positive on support (4.6/5, most recent verified quote from Aug 2025 praises the support team). Do not use a support-decline narrative for Aladtec without a real, dated, verifiable quote. The verified, checkable post-acquisition change is positioning, not support: see below.**
...
- **M7 IS NOT Y COMBINATOR BACKED (guardrail added 2026-09-22, founder-flagged).** Its investors are Threshold Ventures (Series A lead), First Round Capital (seed lead), 25m Health / 25madison, Lakehouse Ventures, January Ventures. Re-verified live 2026-09-22. The YC-backed vendor in this dossier is **YouShift (YC W25)**, a physician-group scheduler, which is a separate company; do not transfer YC status from one to the other. No live page on our site has ever carried a YC claim about M7 (grep-verified 2026-09-22); keep it that way.
...
## MYDUTY (personal nurse calendar app)

**Product:** Personal shift-calendar app for nurses (not a hospital scheduling system). Developer: 4wheels. App Store listing "MYDUTY - Nurse Calendar", https://apps.apple.com/us/app/myduty-nurse-calendar/id990247742 (also on Google Play).
- Price, verbatim from the App Store listing: "Free with in-app purchases".
- Description, verbatim: "Say hello to MYDUTY, your new best friend for managing your nursing schedule!"
- Group feature, verbatim: "Create groups and invite your team - see everyone's schedule at once in 'Member Duty'".
- Guardrail: it shows shifts the nurse enters; it does not build a hospital's schedule. Do not quote its star rating (drifts); if ever needed, re-read the listing the same day.
- Verified: 2026-09-26 (App Store listing fetched directly)
...
- **PUBLISHED PRICING, and it corrects a standing gap.** Verbatim: "$5 per month, per staff member.
  ...
  the Manager tier.)
- **Nurse app is FREE, vendor-stated (verified 2026-09-08).** Verbatim: "Yep, 100% free for nurses and
  healthcare workers!" (nursegrid.com/for-nurses/nursegrid-app/). Same page lists what the nurse app does:
  "Manage your work calendar. Coordinate schedules with coworkers. Track credentials and get reminders for
  expiration dates. Earn CE credits." Credential reminders are a NURSE-side app feature, not a Manager-tier
  scheduling rule.
- **Manager-to-app workflow, vendor-stated (verified 2026-09-08).** Verbatim: "Managers schedule, staff gets
  notified in the mobile app. Staff can self-schedule, pick shifts, and stay updated through their Nursegrid
  app." and, on open shifts: "Visible gaps in the schedule let your team pick them up faster and easier than
  ever" (nursegrid.com/for-organizations/nursegrid-manager/). Pricing line and the 250-staff / critical
  access hospitals positioning re-confirmed verbatim on the same date. Help center landing
  (healthstreamhelp.mcoutput.com/nursegridmanager/Content/NG_Manager/ManagerLandingPage.htm) re-confirmed
  "Last updated: 9/9/2025"; the individual topic pages render only a login shell to automated fetchers, so
  cite the landing URL and name the topic.
...
**CAH REFERENCE CUSTOMER (added 2026-09-22, founder-flagged; corrects a prior "no CAH references" claim):** ScheduleAnywhere HAS one documented Critical Access Hospital reference. Source: "How Two Healthcare Facilities Improved Efficiency by Updating Their Scheduling Methods," a **vendor-written case study published by AONL in April 2019** (https://www.aonl.org/system/files/media/file/2019/04/schedule-anywhere-casestudy.pdf, verified 2026-09-22 by direct PDF read).

- Verbatim: "Sarah D. Culbertson Memorial Hospital is a 22-bed Critical Access Hospital that employs more than 200 staff members who provide around-the-clock care and support services for patients."
- Verbatim: "...registered nurse Rhonda Briney and her team were experiencing at Sarah D. Culbertson Memorial Hospital, a critical access facility in Rushville, Illinois."
- Briney is "a medical/surgical supervisor and patient care coordinator for acute and swing bed services" who "oversees scheduling for over 50 nurses."
- Second facility in the same PDF is Firelands Regional Medical Center (424 beds, Sandusky OH), NOT a CAH.
- **Caveats that must travel with this fact:** it is vendor-authored marketing content, not independent AONL research (the PDF closes with a ScheduleAnywhere CTA and an "About Atlas Business Solutions" block); it is seven years old; it PREDATES TCP's acquisition; and it makes NO CMS §485.635, audit-trail, or FLSA claim, so our compliance-gap framing is unaffected.
- TCP's own customer-story page (tcpsoftware.com/customer-story/sarah-d-culbertson-memorial-hospital/) now redirects to the generic resource library (checked 2026-09-22), so AONL is the durable citation.
- **Useful to us:** Briney's described pre-software state was self-scheduling across two paper documents plus an Excel spreadsheet, which is our own thesis in a CAH nurse's words inside a competitor's case study.
...
| Date       | Action                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 2026-09-26 | Added **MYDUTY** section (personal nurse calendar app; App Store listing verified: 4wheels, "Free with in-app purchases", group 'Member Duty' feature) for the best-nurse-scheduling-app nurse-side section. |
...
| 2026-09-15 | Publishing `scheduling-software-vendor-acquisition-support` (Topic 20) surfaced a fabricated-content near-miss: the draft (written pre-session) claimed TCP Software acquired Aladtec in "2019" and quoted "multiple Capterra reviewers" saying support declined after the acquisition. Neither checked out. Page-verified via TCP's own BusinessWire press release: the real date is **October 21, 2021**. Direct Capterra fetch found no support-decline review at all; current sentiment is positive (4.6/5, most recent verified quote Aug 2025 praises support). Corrected the acquisition date in this dossier's Aladtec entry and in two live posts (`aladtec-vs-managed-service`, `tcp-scheduling-software-vs-managed-service`) that had inherited "2019" from the same draft during cross-linking. Rewrote the draft's case study around the dossier's already-verified, checkable fact instead: Aladtec's post-acquisition positioning dropped healthcare entirely (2026-08-25 and 2026-09-01 findings above), which is real and citable, unlike the support-decline claim. | Claude |
