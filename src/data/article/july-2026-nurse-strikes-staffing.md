...
metadata:
  canonical: 'https://simplescheduleai.com/articles/july-2026-nurse-strikes-staffing'
---
...
5. If the tallies look bad, fix distribution before pay: the strike lists and the [JAMA data](https://jamanetwork.com/journals/jamanetworkopen/fullarticle/2844818) both put staffing conditions ahead of wages.

<div class="not-prose my-12 rounded-xl bg-primary/5 border border-primary/20 px-8 py-10 text-center">
  <p class="text-lg font-semibold text-default mb-2">The schedule is your staffing policy. Make it defensible.</p>
  <p class="text-muted text-sm mb-6">SimpleScheduleAI enforces coverage rules, tracks fairness, and turns callouts into a shortlist instead of a phone tree.</p>
