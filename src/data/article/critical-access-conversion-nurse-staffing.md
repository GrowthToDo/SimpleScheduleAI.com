...
excerpt: >
  Conversions have roughly doubled since 2019, and two more hospitals moved toward it in six days this
...
**Columbia Memorial Hospital, Hudson, New York.** Albany Med Health System has proposed reclassifying the hospital as a critical access hospital. [WAMC reported on August 20](https://www.wamc.org/news/2026-08-20/columbia-memorial-hospital-radio-tech-push-to-downsize-ignores-reality) that this would reduce it from 192 beds to a maximum of 25. Albany Med cites multi-million dollar annual operating deficits. Union-represented staff oppose it, and their objection is about capacity rather than finance: an X-ray technician quoted by WAMC said "We actually need more beds. People end up boarding in the emergency room for days at a time because we don't have the beds upstairs."

Staff also dispute the hospital's bed-availability figures, saying that on one day in June the hospital reported 33 available beds while their own count found four. That is a claim by staff reported in one outlet, not an established finding, and it is worth treating as contested rather than settled. The wider point stands on its own: bed-availability data is the evidence base for a conversion decision, and the people who work the floor did not recognize it.
...
3. **Check whether your state adds a requirement on top of the federal one.** In Texas an RN must be on duty in each building holding patients, which the federal rule alone does not require.
4. **Ask where your eligibility comes from.** Distance, or necessary-provider designation. The answer determines how exposed you are to the review process CMS described in August, and it is a question your administrator should be able to answer in one sentence.
5. **Look at your bed-availability data the way a skeptic would.** The dispute at Columbia Memorial is a reminder that this data is the evidence base for the decision, and that the people working the floor will notice if it does not match what they see.
...
[8] [26 TAC 505.41(o)(2)(D)](https://www.law.cornell.edu/regulations/texas/26-Tex-Admin-Code-SS-505-41), Texas hospital licensing: an RN on duty in each building containing a nursing unit where patients are present.
