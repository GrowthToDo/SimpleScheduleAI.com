...
<div class="not-prose my-12 rounded-xl bg-primary/5 border border-primary/20 px-8 py-10 text-center">
  <p class="text-lg font-semibold text-default mb-2">Stop Rebuilding Your Schedule Every Week</p>
  <p class="text-muted text-sm mb-6">SimpleScheduleAI builds your CAH nurse schedule with charge coverage enforced, overtime checked, and CMS documentation generated automatically. You review and approve. First schedule inside two weeks of your roster upload.</p>
