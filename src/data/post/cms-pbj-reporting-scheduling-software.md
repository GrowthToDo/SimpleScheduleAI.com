...
<div class="not-prose my-12 rounded-xl bg-primary/5 border border-primary/20 px-8 py-10 text-center">
  ...
  <p class="text-muted text-sm mb-6">SimpleScheduleAI keeps a complete audit trail for every schedule and change by default, so your staffing-assignment record is clean and dated. Built for Texas Critical Access Hospitals, with flat monthly pricing and no IT setup.</p>
