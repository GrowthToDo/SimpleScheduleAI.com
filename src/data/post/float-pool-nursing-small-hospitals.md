...
- The average cost to replace one staff RN is $60,090 per the [2026 NSI National Health Care Retention Report](https://www.nsinursingsolutions.com/documents/library/nsi_national_health_care_retention_report.pdf), so the goal of any small-hospital model is to cover gaps without burning out the few nurses who always agree to pick up the extra shifts
