...
4. **How are CMS and FLSA requirements handled?** Confirm whether CMS [§485.635](https://www.ecfr.gov/current/title-42/chapter-IV/subchapter-G/part-485/subpart-F/section-485.635) documentation and FLSA overtime thresholds are configured for you or left to your team, and who keeps that configuration audit-ready.

5. **What is the exit path, and which product is it?** Know the renewal date, the notice window, and how you would export your roster data. If you are offered a legacy Kronos product, note that on-premise Workforce Central reaches end of life on [March 31, 2027](https://www.healthcareitleaders.com/blog/ukg-workforce-central-wfc-end-of-life/).
...
<div class="not-prose my-12 rounded-xl bg-primary/5 border border-primary/20 px-8 py-10 text-center">
  <p class="text-lg font-semibold text-default mb-2">A scheduling tool sized for a 25-bed hospital, not a 200-bed system.</p>
  <p class="text-muted text-sm mb-6">SimpleScheduleAI is purpose-built for Texas Critical Access Hospitals. No IT setup, no platform to configure, operational inside two weeks.</p>
