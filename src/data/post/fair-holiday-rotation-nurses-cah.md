...
Holiday callouts need a defined response protocol written before the holiday arrives. When a nurse in the mandatory rotation calls out of a holiday shift, the replacement sequence is: (1) per-diem nurses on the holiday coverage roster, (2) nurses from the off-holiday group who have volunteered for holiday overtime, (3) nurses from the other off-holiday group. The on-call nurse manager does not personally contact nurses in random order; they work the list. Building that list, and the rest of the October-to-New-Year plan, is covered in [how to cover holiday nurse callouts](/blog/december-nurse-callout-surge-cah).
