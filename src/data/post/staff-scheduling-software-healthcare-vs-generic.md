---
# CANNIBALIZATION (2026-07-26): do NOT publish — duplicate of employee-scheduling-software-for-healthcare. Content salvaged into it 2026-07-26; safe to delete. See docs/seo/draft-consolidation-plan.md
draft: true
...
<div class="not-prose my-12 rounded-xl bg-primary/5 border border-primary/20 px-8 py-10 text-center">
  <p class="text-lg font-semibold text-default mb-2">Stop managing compliance manually on top of a generic scheduling tool.</p>
  <p class="text-muted text-sm mb-6">SimpleScheduleAI covers all five healthcare-specific requirements out of the box.</p>
