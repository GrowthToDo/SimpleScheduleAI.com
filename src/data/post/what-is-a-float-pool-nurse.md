...
title: 'What Is a Float Pool Nurse? Role, Pay, and How Floating Works'
excerpt: >
  A float pool nurse covers whichever unit is short that day. Big hospitals use them to fill
  holes without calling an agency. A 25-bed hospital has one floor, so there is nowhere to
  float and nobody spare to float.
image: ~/assets/images/pool/one-on-one-03.webp
...
tags:
  ...
  - coverage
metadata:
  canonical: 'https://simplescheduleai.com/blog/what-is-a-float-pool-nurse'
---
...
- Hospitals normally require real experience before they will float someone. [WakeMed](https://www.wakemed.org/careers/nursing-careers/float-pool-and-contract-positions) asks that applicants "have worked in the skills area applied for in a hospital for the past two years."
...
- Floating carries a real safety concern. The [New York State Nurses Association](https://www.nysna.org/position-statement-floating) says floating to unfamiliar specialty units "poses grave concerns regarding patient safety and potential liability for both the professional nurse as well as the facility."
...
- [What Does a Float Pool Nurse Do?](#what-does-a-float-pool-nurse-do)
- [How Is a Float Pool Nurse Different From a Travel Nurse or a PRN Nurse?](#how-is-a-float-pool-nurse-different-from-a-travel-nurse-or-a-prn-nurse)
...
- [How Does SimpleScheduleAI Decide Which Nurse Covers a Short Shift?](#how-does-simplescheduleai-decide-which-nurse-covers-a-short-shift)
...
Where they can be sent is set by what they are signed off for. Being signed off means the hospital has documented that a nurse is competent to work a particular unit, usually after an orientation period and a competency checklist. [WakeMed](https://www.wakemed.org/careers/nursing-careers/float-pool-and-contract-positions) is a large North Carolina system. Its float nurses work "within skill areas" that include "Medical/Surgical, Telemetry and Stepdown, Critical Care," with the list running further depending on a nurse's experience. Applicants need two years of hospital experience "in the skills area applied for."
...
<div class="not-prose overflow-x-auto my-8">
  <table class="min-w-full table-fixed break-words align-top text-sm border border-slate-200 dark:border-slate-700">
    <thead class="bg-slate-50 dark:bg-slate-800">
      <tr>
        <th class="px-3 py-2 text-left font-semibold border-b border-slate-200 dark:border-slate-700"></th>
        <th class="px-3 py-2 text-left font-semibold border-b border-slate-200 dark:border-slate-700">Float pool nurse</th>
        <th class="px-3 py-2 text-left font-semibold border-b border-slate-200 dark:border-slate-700">Travel nurse</th>
        <th class="px-3 py-2 text-left font-semibold border-b border-slate-200 dark:border-slate-700">Per diem or PRN nurse</th>
        <th class="px-3 py-2 text-left font-semibold border-b border-slate-200 dark:border-slate-700">Unit staff nurse</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td class="px-3 py-2 border-b border-slate-100 dark:border-slate-800 font-medium">Who employs them</td>
        <td class="px-3 py-2 border-b border-slate-100 dark:border-slate-800">The hospital</td>
        <td class="px-3 py-2 border-b border-slate-100 dark:border-slate-800">A staffing agency, on contract to the hospital</td>
        <td class="px-3 py-2 border-b border-slate-100 dark:border-slate-800">The hospital, on as-needed terms</td>
        <td class="px-3 py-2 border-b border-slate-100 dark:border-slate-800">The hospital</td>
      </tr>
      <tr>
        <td class="px-3 py-2 border-b border-slate-100 dark:border-slate-800 font-medium">Where they work</td>
        <td class="px-3 py-2 border-b border-slate-100 dark:border-slate-800">Any unit in that hospital they are signed off for</td>
        <td class="px-3 py-2 border-b border-slate-100 dark:border-slate-800">A different facility each contract, often in another state</td>
        <td class="px-3 py-2 border-b border-slate-100 dark:border-slate-800">Usually one or two units they already know</td>
        <td class="px-3 py-2 border-b border-slate-100 dark:border-slate-800">One home unit</td>
      </tr>
      <tr>
        <td class="px-3 py-2 border-b border-slate-100 dark:border-slate-800 font-medium">Hours guaranteed</td>
        <td class="px-3 py-2 border-b border-slate-100 dark:border-slate-800">Varies. Both benefited lines and as-needed float roles exist</td>
        <td class="px-3 py-2 border-b border-slate-100 dark:border-slate-800">Yes, for the length of the contract</td>
        <td class="px-3 py-2 border-b border-slate-100 dark:border-slate-800">No, they pick up shifts as offered</td>
        <td class="px-3 py-2 border-b border-slate-100 dark:border-slate-800">Yes</td>
      </tr>
      <tr>
        <td class="px-3 py-2 font-medium">What a manager reaches for them to solve</td>
        <td class="px-3 py-2">One unit is short today and another has room</td>
        <td class="px-3 py-2">A vacancy that has lasted months and cannot be hired into</td>
        <td class="px-3 py-2">A single open shift</td>
        <td class="px-3 py-2">Baseline coverage every week</td>
      </tr>
    </tbody>
  </table>
</div>

The pair most often confused is float and per diem. Float describes how many units a nurse covers. Per diem describes the terms she works on. A hospital can have a per diem nurse who only ever works one unit, and a float nurse on a benefited line with set hours who covers four different units. It can also hire float staff on as-needed terms, so neither word tells you the other answer. For the full picture of the as-needed side, see [per diem nursing](/blog/what-is-per-diem-nursing).
...
Joan Borgatti put it from the nurse's side in [American Nurse Today](https://www.myamericannurse.com/tips-for-floaters/) in 2010: "Don't accept an assignment that's beyond your level of competency and could place a patient in jeopardy."
...
See [how AI nurse scheduling works](/ai-nurse-scheduling) and [how it works](/how-it-works), or the wider picture in [critical access hospital scheduling](/critical-access-hospital-scheduling) and [nurse scheduling software](/nurse-scheduling-software).
...
5. **Look at how a schedule can be built around who is cross-trained.** Start at [how it works](/how-it-works), or read the [coverage models that fit a small hospital](/blog/float-pool-nursing-small-hospitals).

<div class="not-prose my-12 rounded-xl bg-primary/5 border border-primary/20 px-8 py-10 text-center">
  <p class="text-lg font-semibold text-default mb-2">Cover the short shift without a float pool</p>
  <p class="text-muted text-sm mb-6">SimpleScheduleAI plans around who on your roster is cross-trained, and ranks replacements when someone calls out. Built for Texas Critical Access Hospitals.</p>
...
Usually not on a unit they are floating into. Charge depends on knowing the unit's policies, people and escalation paths, which is exactly what a floated nurse lacks that day. See [what a charge nurse does](/blog/what-is-a-charge-nurse) for how hospitals set that qualification.
...
[1] New York State Nurses Association, Position Statement on Floating (reviewed March 2018). [nysna.org](https://www.nysna.org/position-statement-floating).

[2] WakeMed, Float Pool and Contract Positions. [wakemed.org](https://www.wakemed.org/careers/nursing-careers/float-pool-and-contract-positions).

[3] Joan C. Borgatti, "Tips for floaters," American Nurse Today (2010), now published as American Nurse Journal. [myamericannurse.com](https://www.myamericannurse.com/tips-for-floaters/).
