...
<div class="not-prose my-12 rounded-xl bg-primary/5 border border-primary/20 px-8 py-10 text-center">
  <p class="text-lg font-semibold text-default mb-2">Review and approve, no 45-minute build sessions at risk of being lost.</p>
  <p class="text-muted text-sm mb-6">SimpleScheduleAI delivers completed drafts to your inbox. No IT setup required.</p>
