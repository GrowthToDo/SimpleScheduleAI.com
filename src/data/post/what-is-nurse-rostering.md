...
**Compliance gaps:** If the roster does not accurately reflect which nurses hold current RN licensure, a schedule built from it may assign shifts that violate CMS §485.635's requirement for RN availability. During a CMS survey, the scheduling record, including who was rostered for each shift, is reviewed against credential verification records.

**Overtime risk:** Without cumulative hours tracking in the roster, nurse managers cannot see who is approaching the 40-hour FLSA threshold until overtime has already been triggered. Roster-level hour tracking enables proactive load balancing before overtime costs accumulate.

**Fairness and retention:** [AONL workforce research](https://www.aonl.org/resources/nursing-workforce-now) consistently identifies perceived scheduling unfairness as a driver of nursing turnover. A roster that tracks cumulative weekend, night, and holiday assignments makes fairness visible and defensible, both to staff and in retention conversations.
...
For more on how nurse rostering connects to scheduling outcomes at small hospitals, see: [Nurse Scheduling Software](/nurse-scheduling-software).
