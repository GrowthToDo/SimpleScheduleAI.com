...
<div class="not-prose my-12 rounded-xl bg-primary/5 border border-primary/20 px-8 py-10 text-center">
  ...
  <p class="text-muted text-sm mb-6">SimpleScheduleAI logs every schedule change with a timestamp and flags overtime thresholds as the schedule is built. No IT setup, operational in 3-5 days.</p>
