...
<div class="not-prose my-12 rounded-xl bg-primary/5 border border-primary/20 px-8 py-10 text-center">
  <p class="text-lg font-semibold text-default mb-2">Want scheduling documentation that holds up in a CMS survey?</p>
  <p class="text-muted text-sm mb-6">SimpleScheduleAI logs every schedule change with a timestamp and flags overtime thresholds as the schedule is built. No IT setup, operational in 3 to 5 business days.</p>
