...
<div class="not-prose my-12 rounded-xl bg-blue-50 dark:bg-slate-800 border border-blue-100 dark:border-slate-700 px-8 py-10 text-center">
  ...
  <p class="text-slate-500 dark:text-slate-400 text-sm mb-6">SimpleScheduleAI assigns a dedicated specialist to each facility. Your nurse manager reviews and approves. No IT setup, operational in 3-5 days.</p>
