...
<div class="not-prose my-12 rounded-xl bg-primary/5 border border-primary/20 px-8 py-10 text-center">
  ...
  <p class="text-muted text-sm mb-6">SimpleScheduleAI assigns a dedicated specialist to each facility. Your nurse manager reviews and approves. No IT setup, operational in 3-5 days.</p>
