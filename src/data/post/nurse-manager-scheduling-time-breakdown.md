...
The five activities below are the ones that came up again and again in the 30+ conversations we had with [nurse managers](/blog/what-is-a-nurse-manager) at a [critical access hospital](/critical-access-hospital-scheduling) scale during SimpleScheduleAI's development. Ask a manager to walk through her scheduling week and the same verbs repeat: chasing availability before the build, building the grid, covering callouts, handling swap requests against the posted schedule, and getting the final copy into the system and onto the board.

The hours are our estimate of a typical week from those same conversations, not measured time studies. The split varies by facility size, roster stability, and current tools; treat the table as a frame to check your own week against. If you are working out which of these hours belong to the manager and which belong to the charge nurse, start with [nurse manager vs charge nurse](/blog/nurse-manager-vs-charge-nurse). The same interview base sits under our [$26,000 scheduling burden](/blog/healthcare-scheduling-crisis) analysis; it cuts the week by process rather than by activity, so its categories and ranges differ from this table's.
...
<div class="not-prose my-12 rounded-xl bg-primary/5 border border-primary/20 px-8 py-10 text-center">
  <p class="text-lg font-semibold text-default mb-2">Where do your 10 hours go? Start with callout coverage.</p>
  <p class="text-muted text-sm mb-6">SimpleScheduleAI takes on the build, the cover scramble, and the overtime checks, and hands back a post-ready schedule.</p>
